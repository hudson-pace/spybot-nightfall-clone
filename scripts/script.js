...
function loadAssets(allAssetsLoadedCallback) {
  ...
  const assetNames = [
    ...
    'worlds/nightfall_incident/battles.json', 'worlds/nightfall_incident/netmap.json', 'agents.json', 'commands.json',
  ];
  let loadedCount = 0;
...
$(document).ready(() => {
  ...
  loadAssets(() => {
    ...
    ViewManager('./assets/worlds/nightfall_incident', assets);
  });
});
